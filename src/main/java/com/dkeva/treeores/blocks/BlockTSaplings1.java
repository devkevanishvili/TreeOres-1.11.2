 ...
 if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos)) return;
    ...
    IBlockState leafState;
        ...
        case GOLD:
            ...
            leafState = TBlocks.TLeaves1.getDefaultState().withProperty(BlockTLogs1.VARIANT, TV1.GOLD).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres1(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
        case COAL:
            logState = TBlocks.TLogs1.getDefaultState().withProperty(BlockTLogs1.VARIANT, TV1.COAL);
            leafState = TBlocks.TLeaves1.getDefaultState().withProperty(BlockTLogs1.VARIANT, TV1.COAL).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres1(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
        case REDSTONE:
            logState = TBlocks.TLogs1.getDefaultState().withProperty(BlockTLogs1.VARIANT, TV1.REDSTONE);
            leafState = TBlocks.TLeaves1.getDefaultState().withProperty(BlockTLogs1.VARIANT, TV1.REDSTONE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres1(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
    }
