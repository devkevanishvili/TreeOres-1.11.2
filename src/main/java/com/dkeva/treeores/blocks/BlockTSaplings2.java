 ...
 if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos)) return;
    ...
    IBlockState leafState;
        ...
        case EMERALD:
            ...
            leafState = TBlocks.TLeaves2.getDefaultState().withProperty(BlockTLogs2.VARIANT, TV2.EMERALD).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres2(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
        case LAPIS:
            logState = TBlocks.TLogs2.getDefaultState().withProperty(BlockTLogs2.VARIANT, TV2.LAPIS);
            leafState = TBlocks.TLeaves2.getDefaultState().withProperty(BlockTLogs2.VARIANT, TV2.LAPIS).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres2(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
        case OBSIDIAN:
            logState = TBlocks.TLogs2.getDefaultState().withProperty(BlockTLogs2.VARIANT, TV2.OBSIDIAN);
            leafState = TBlocks.TLeaves2.getDefaultState().withProperty(BlockTLogs2.VARIANT, TV2.OBSIDIAN).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres2(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
    }
