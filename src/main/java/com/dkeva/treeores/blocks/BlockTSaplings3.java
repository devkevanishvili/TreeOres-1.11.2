 ...
 if (!net.minecraftforge.event.terraingen.TerrainGen.saplingGrowTree(worldIn, rand, pos)) return;
    ...
    IBlockState leafState;
        ...
        case QUARTZ:
            ...
            leafState = TBlocks.TLeaves3.getDefaultState().withProperty(BlockTLogs3.VARIANT, TV3.QUARTZ).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres3(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
        case XP:
            logState = TBlocks.TLogs3.getDefaultState().withProperty(BlockTLogs3.VARIANT, TV3.XP);
            leafState = TBlocks.TLeaves3.getDefaultState().withProperty(BlockTLogs3.VARIANT, TV3.XP).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
            worldgenerator = new WorldGenTreeOres3(true,  4 + rand.nextInt(5), logState, leafState, false);
            break;
    }
